...
const ContactSection = () => {
  ...
  if (state.succeeded) {
    return (
      <section
        id=""
        className="bg-white py-24 px-8 text-center min-h-[50vh] flex flex-col items-center justify-center"
      >
        ...
        <h2 className="text-3xl font-serif text-[#1A202C] mb-4">
    ...
    <section id="contact" className="bg-white py-24 px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white order-2 lg:order-1 p-8 rounded-2xl shadow-lg shadow-gray-100 border border-gray-50">
          ...
          <div className="bg-[#3B82F6] order-1 lg:order-2 p-10 rounded-2xl shadow-xl h-full text-white relative overflow-hidden flex flex-col justify-center">
